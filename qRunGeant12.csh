...
# setenv intype pico
# setenv etacut 1
# setenv OutBase Geant12_NoEff_NoBg_MB
# setenv trig all
...
setenv intype pico
setenv etacut 1
setenv OutBase Geant12_NoEff_NoBg_HT54
setenv trig all
...
# setenv etacut 7
# setenv OutBase McGeant12_NoEff_NoBg_MB
# setenv trig all
...
foreach File ( Data/AddedEmbedPythiaRun12pp200/Cleanpp12*root )
    ...
    echo "Logging errors to " $ErrFile
    echo to resubmit:
    echo qsub -V -q  erhiq -l mem=2gb -W umask=0022 -N Geant12Groom -o $LogFile -e $ErrFile -- ${ExecPath}/qwrap.sh ${ExecPath} $Exec $Args
    echo

    qsub -V -p 10 -q  erhiq -l mem=2gb -W umask=0022 -N Geant12Groom -o $LogFile -e $ErrFile -- ${ExecPath}/qwrap.sh ${ExecPath} $Exec $Args
